...
cfg = LanguageModelSAERunnerConfig(
    ...
    model_name="qwen1.5-0.5b",  # our model (more options here: https://neelnanda-io.github.io/TransformerLens/generated/model_properties_table.html)
    ...
    from_pretrained_path="/root/autodl-tmp/huggingface/qwen1.5-0.5b_blocks.13.hook_resid_pre_32768/",
